  ...
  return (
    <div>
      ...
      <div className="btnContainer" id='btnContainer'>
        <div className='nav btn' onClick={goBackward}>◀ BACK</div>
        <div className='nav info flash' id="info" onClick={goForward}>"TOUCH TO START"</div>
        <div className='nav btn' onClick={goForward} >NEXT ▶</div>
      </div>
    </div>
  );
}
